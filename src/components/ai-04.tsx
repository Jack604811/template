...
const ACTIONS = [
  { 
    ...
    prompt: "Check for any booking conflicts or overlapping reservations"
  },
  { 
    id: "demand-analysis", 
    icon: IconLayoutDashboard, 
    label: "Demand Analysis",
    prompt: "Show me demand analysis and peak hours for bookings"
  },
  { 
    id: "draft-message", 
    icon: IconTemplate, 
    label: "Draft Message",
    prompt: "Draft a confirmation message for the next booking"
  },
  { 
    id: "operational-insights", 
    icon: IconFileUpload, 
    label: "Operational Insights",
    prompt: "What are the current operational insights and alerts?"
  },
];
...
export default function Ai04({
  ...
  return (
    <div className="mx-auto flex w-full h-screen flex-col items-center justify-center gap-4">
      ...
      <h2 className="-my-5 pb-4 text-center text-xl text-muted-foreground">
        Manage your bookings, detect duplicated bookings and get operational insights
      </h2>
      ...
      <div className="relative z-10 flex flex-col w-full mx-auto max-w-2xl content-center">
        ...
        >
          ...
          <Textarea
            ...
            placeholder="Ask about availability, conflicts, pricing, schedules, or operational rules..."
            value={prompt}
          />
      ...
      <div className="max-w-250 mx-auto flex-wrap gap-3 flex min-h-0 shrink-0 items-center justify-center">
        {ACTIONS.map((action) => (
          <Button
            ...
            variant="outline"
            onClick={() => {
              // Set the actual prompt text in the input field
