...
function Dialog({
  ...
  if (isMobile) {
    return (
      <DialogContext.Provider value={{ isMobile: true }}>
        <Drawer
          open={open}
  ...
  return (
    <DialogContext.Provider value={{ isMobile: false }}>
...
function DialogContent({
  ...
  if (isMobile) {
    return (
      <DrawerContent data-slot="dialog-content">
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  const { isMobile } = React.useContext(DialogContext);
  if (isMobile) {
    // On mobile the title lives in the drawer header above; render children inline
...
function DialogTitle({
  ...
  const { isMobile } = React.useContext(DialogContext);
  if (isMobile) {
    // Visual title is rendered in the drawer header; keep this for accessibility only
    return (
      <DrawerTitle data-slot="dialog-title" className="sr-only" {...props} />
    );
  }
  return (
