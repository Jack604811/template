// Height of calendar bookings in pixels - used in month, week and day views
export const BookingHeight = 24

// Vertical gap between bookings in pixels - controls spacing in month view
export const BookingGap = 4
